 ...
 *
 * Accessible at <code>/api/rest/products/:product/related</code>.
 ...
 * @license MIT
 */
class Clockworkgeek_Extrarestful_Model_Api2_Product_Related extends Clockworkgeek_Extrarestful_Model_Api2_Product
{
    ...
    protected function _getCollection()
    {
        ...
        $products = $product->getRelatedProductCollection();
