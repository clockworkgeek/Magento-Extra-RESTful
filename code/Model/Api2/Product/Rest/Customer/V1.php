 ...
 */
class Clockworkgeek_Extrarestful_Model_Api2_Product_Rest_Customer_V1 extends Clockworkgeek_Extrarestful_Model_Api2_Product_Public
{
    ...
    {
        return parent::_getCollection()->addPriceData($this->_customer->getGroupId());
    }
